...
public class FabricsProductPage {

    private final String fabricsUrl;
    ...
    public FabricsProductPage(WebDriver driver) {
        this.driver     = driver;
        this.wait       = new WaitUtils(driver);
        this.shortWait  = new WebDriverWait(driver, Duration.ofSeconds(5));
        this.fabricsUrl = new ConfigReader().getFabricsUrl();
    }

    // ── Navigation ────────────────────────────────────────────

    public void navigateToFabricsAndSelectFirst() {
        driver.get(fabricsUrl);
        ...
        try {
            ...
            System.out.println("[FabricsProductPage] Primary product card locator failed, trying fallback: " + e.getMessage());
    ...
    public String getProductName() {
        try {
            ...
            System.out.println("[FabricsProductPage] h1 locator failed, trying fallback: " + e.getMessage());
    ...
    public String getProductPrice() {
        try {
            ...
            System.out.println("[FabricsProductPage] Price primary locator failed, trying fallback: " + e.getMessage());
    ...
    public void clickAddToCart() {
        try {
            ...
            System.out.println("[FabricsProductPage] Add to Cart primary failed, trying fallback: " + e.getMessage());
            WebElement btn = wait.waitForVisible(addToCartBtnFallback);
            ((JavascriptExecutor) driver).executeScript("arguments[0].click();", btn);
        }
